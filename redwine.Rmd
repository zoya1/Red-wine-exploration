...
a1 <- ggplot(aes(y=alcohol,x =quality),
  ...
  labs(x = 'Quality', y = 'Alcohol(%/vol) Median')
...
a2 <- ggplot(aes(y=density,x =quality),
  ...
  labs(x = 'Quality', y = 'Density(g/cm^3) Median')
...
a4 <- ggplot(aes(y= residual.sugar, x = quality),
  ...
  labs(x = 'Quality', y = 'Residual Sugar(g/dm^3) Median')
...
a5 <- ggplot(aes(y= total.sulfur.dioxide,x =quality),
  ...
  labs(x = 'Quality', y = 'Total SO2(mg/dm^3) Median')
...
a6 <- ggplot(aes(y= free.sulfur.dioxide,x =quality),
  ...
  labs(x = 'Quality', y = 'Free SO2(mg/dm^3) Median')
